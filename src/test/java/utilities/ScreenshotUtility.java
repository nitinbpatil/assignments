...
public class ScreenshotUtility implements ITestListener {
	...
	private Logger Log = Logger.getLogger(ScreenshotUtility.class.getName());
	...
	public void onTestSuccess(ITestResult tr) {
		...
		Log.info("Inside onTestSuccess() method...");
		if (ConfigProperties.getProperty("ScreenShotOnPass").equalsIgnoreCase("Yes")) {
			Log.info("ScreenShotOnPass: " + ConfigProperties.getProperty("ScreenShotOnPass"));
	...
	public void onTestFailure(ITestResult tr) {
		...
		Log.info("Inside onTestFailure() method...");
		if (ConfigProperties.getProperty("ScreenShotOnFail").equalsIgnoreCase("Yes")) {
			Log.info("ScreenShotOnFail: " + ConfigProperties.getProperty("ScreenShotOnFail"));
	...
	public void captureScreenShot(ITestResult result, String status) {
		Log.info("Inside captureScreenShot() method...");
		String destDir = "";
		...
		if (status.equalsIgnoreCase("fail")) {
			destDir = "src/test/java/screenshots/Failures";
		}
		// If status = pass then set folder name "screenshots/Success"
		else if (status.equalsIgnoreCase("pass")) {
			destDir = "src/test/java/screenshots/Success";
		}
